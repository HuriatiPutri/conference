                    ...
                    <div class="card-body">
                        <form action="{{ route('conference.update', $conference->public_id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('initial') is-invalid @enderror" id="initial" name="initial" value="{{ old('initial', $conference->initial) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('date') is-invalid @enderror" id="date" name="date" value="{{ old('date', $conference->date ? $conference->date->format('Y-m-d') : '') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-2">
                                    <img src="{{ Storage::url($conference->cover_poster_path) }}" alt="Current Poster" class="img-thumbnail cover-poster-preview">
                                ...
                                <div class="form-check mt-2">
                                    <input class="form-check-input" type="checkbox" name="remove_cover_poster" id="remove_cover_poster" value="1">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('city') is-invalid @enderror" id="city" name="city" value="{{ old('city', $conference->city) }}" required>
                                    @error('city')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('country') is-invalid @enderror" id="country" name="country" value="{{ old('country', $conference->country) }}" required>
                                    @error('country')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('year') is-invalid @enderror" id="year" name="year" value="{{ old('year', $conference->year) }}" required min="{{ date('Y') - 10 }}" max="{{ date('Y') + 10 }}">
                                @error('year')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('online_fee') is-invalid @enderror" id="online_fee" name="online_fee" value="{{ old('online_fee', $conference->online_fee) }}" required min="0">
                                </div>
                                @error('online_fee')
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control @error('onsite_fee') is-invalid @enderror" id="onsite_fee" name="onsite_fee" value="{{ old('onsite_fee', $conference->onsite_fee) }}" required min="0">
                                </div>
                                @error('onsite_fee')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <span class="input-group-text">Rp</span>
                                    <input type="number" step="0.01" class="form-control @error('participant_fee') is-invalid @enderror" id="participant_fee" name="participant_fee" value="{{ old('participant_fee', $conference->participant_fee) }}" required min="0">
                                </div>

                ...
                <div class="card card-primary card-outline">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table id="activityLogsTable" class="table-bordered table-hover table-striped table">
                        <thead>
                          <tr>
                            <th>No</th>
                            <th>Level</th>
                  ...
                  <div class="card-footer clearfix">
                    ...
                    <small class="text-muted float-right">Total: {{ $activityLogs->count() }} Activity Logs</small>
                  </div>
                </div>
              </div>
            </div>

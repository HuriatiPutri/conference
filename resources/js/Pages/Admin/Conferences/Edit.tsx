...
import { ActionIcon, Button, Card, Container, Divider, Flex, Grid, Group, Image, NumberInput, Stack, Text, Textarea, TextInput, Title } from '@mantine/core';
...
function ConferenceCreate() {
  ...
  const { data, setData, errors, post, processing } = useForm<ConferenceFormData>({
    ...
    member_discount_percentage: conference.data.member_discount_percentage || 0,
    rooms: rooms,
  });

...
function VoucherEdit() {
  const { voucher } = usePage<any>().props;
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    post(route('vouchers.update', voucher.id), {
      onSuccess: () => {
        notifications.show({ message: 'Voucher updated successfully!', color: 'green' });
  ...
  return (
    <MainLayout title="Edit Voucher">
      <Container size="md" py="xl">
        <Stack gap="lg">
          <Group justify="space-between">
            <div>
              <Title order={2}>Edit Voucher</Title>
              <Text c="dimmed" size="sm">Update voucher period, quota, and usage target</Text>
            </div>
              ...
              <Stack gap="md">
                ...
                <Checkbox
                  ...
                  onChange={(e) => setData('applies_to', e.target.checked
                    ...
                    : data.applies_to.filter((x: string) => x !== 'conference_registration'))}
                />
                <Checkbox
                  label="JOIV Article"
                  ...
                  onChange={(e) => setData('applies_to', e.target.checked
                    ...
                    : data.applies_to.filter((x: string) => x !== 'joiv_article'))}
                />
                <Checkbox
                  ...
                  onChange={(e) => setData('applies_to', e.target.checked
                    ...
                    : data.applies_to.filter((x: string) => x !== 'membership_registration'))}
                />
                ...
                <Group justify="flex-end" pt="md">
                  ...
                  <Button type="submit" loading={processing}>Update Voucher</Button>
                </Group>
              </Stack>
            </form>
          </Card>
